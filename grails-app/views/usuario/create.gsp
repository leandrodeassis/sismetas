...
<!--                            <tr class="prop">
                ...
                <div class="buttons">
                    <span class="button"><g:submitButton name="create" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" onclick="return confirm('${message(code: 'default.button.create.confirm.message', default: 'Será enviado uma senha para o email cadastrado, deseja continuar?')}');" /></span>
                </div>
            </g:form>
        </div>
    </body>
