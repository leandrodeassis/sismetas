    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${campiInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="cursos"><g:message code="campi.cursos.label" default="Cursos" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: campiInstance, field: 'cursos', 'errors')}">
...
<g:link controller="curso" action="create" params="['campi.id': campiInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'curso.label', default: 'Curso')])}</g:link>
